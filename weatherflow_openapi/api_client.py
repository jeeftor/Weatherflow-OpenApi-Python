...
import weatherflow_openapi.models
from weatherflow_openapi import rest
from weatherflow_openapi.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(weatherflow_openapi.models, klass)
