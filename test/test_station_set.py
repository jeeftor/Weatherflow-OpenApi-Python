...
from weatherflow_openapi.models.station_set import StationSet  # noqa: E501

class TestStationSet(unittest.TestCase):
    """StationSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StationSet:
        """Test StationSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StationSet`
        """
        model = StationSet()  # noqa: E501
        if include_optional:
            return StationSet(
                ...
                locations = [
                    weatherflow_openapi.models.station.Station(
                        station_id = 67, 
                        name = 'Home', 
